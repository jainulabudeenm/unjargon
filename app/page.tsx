...
import {
  ...
  CreditCard, ArrowRight, ArrowLeft, Shuffle
} from 'lucide-react';
    ...
    terms: [
      {
        ...
        analogy: "The Wireframe.",
        description: "Defines the raw structure. It tells the browser 'this is a button' or 'this is a heading,' but has no opinion on what they look like."
      },
      {
        name: "CSS (Cascading Style Sheets)",
        analogy: "Visual Design & Auto-Layout.",
        description: "Applies the branding. This is where hex codes, typography, padding, and layout rules (like Flexbox or Grid) live."
      },
      {
        name: "JavaScript (JS)",
        analogy: "The Interactive Logic.",
        description: "The engine that makes things 'do' something. If a user clicks a button and a modal pops up, JavaScript is doing the work."
      }
    ]
  },
  {
    ...
    terms: [
      {
        ...
        analogy: "The Developer's Figma.",
        description: "The primary app for writing code (like VS Code or Cursor). It's an advanced text editor with features like auto-complete and error checking."
      },
      {
        name: "CLI (Command Line Interface)",
        analogy: "The Quick Command Palette (Cmd + /).",
        description: "The Terminal app. Instead of clicking buttons, developers type text commands to tell the computer what to do instantly."
      },
      {
        name: "Homebrew",
        analogy: "The App Store for the Terminal.",
        description: "A tool used to install software (like Node.js or Figma) via a single text command instead of downloading setup files manually."
      }
    ]
  },
  {
    ...
    terms: [
      {
        name: "Git",
        analogy: "Version History on steroids.",
        description: "A tracking system that takes snapshots of code. If a new feature breaks the app, developers can instantly rewind to a working snapshot."
      },
      {
        name: "GitHub",
        analogy: "The Cloud Workspace.",
        description: "A website where Git snapshots are uploaded to be backed up and shared with a team, similar to a shared Figma project."
      }
    ]
  },
  {
    ...
    terms: [
      {
        name: "Node.js",
        analogy: "The Engine.",
        description: "Software that allows JavaScript to run outside of a browser, turning your computer into a machine capable of running full apps."
      },
      {
        name: "Framework",
        analogy: "The Structural Blueprint.",
        description: "A pre-written foundation for an app (like Next.js) so developers don't have to build basic mechanics like page navigation from scratch."
      },
      {
        name: "Next.js",
        analogy: "The Industry-Standard Blueprint.",
        description: "Currently the most popular framework for building fast, modern web apps. It's the 'pro' version of building with React."
      },
      {
        name: "App Router",
        analogy: "The Navigation Logic.",
        description: "The system inside Next.js that manages how pages connect. It handles moving the user from '/home' to '/settings' smoothly."
      }
    ]
  },
  {
    ...
    terms: [
      {
        ...
        analogy: "The Default Figma Community.",
        description: "The standard marketplace where developers download code pieces (like a calendar picker) to add to their project."
      },
      {
        name: "yarn / pnpm / bun",
        analogy: "Alternative Plugin Managers.",
        description: "Different 'brands' of managers. Yarn is a faster alternative; pnpm saves hard drive space by sharing files; Bun is the new, blazing-fast 'super-app' version."
      }
    ]
  },
  {
    ...
    terms: [
      {
        name: "TailwindCSS",
        analogy: "Design Tokens applied via code.",
        description: "A framework that lets developers use shorthand tokens (like 'rounded-lg') directly in their layout code instead of writing separate CSS files."
      },
      {
        name: "TypeScript",
        analogy: "Strict Component Properties.",
        description: "An add-on to JavaScript that enforces rules (data types). It ensures a 'Price' field only accepts numbers, not text, preventing crashes."
      },
      {
        name: "ESLint",
        analogy: "An automated Design Linter.",
        description: "A tool that scans code for inconsistencies, forcing the whole team to follow the same spacing and style rules."
      }
    ]
  },
  {
    ...
    terms: [
      {
        ...
        description: "A secure system (like a complex Airtable) that stores user profiles, posts, and settings permanently."
      },
      {
        name: "Auth Provider",
        analogy: "The Bouncer.",
        description: "A service (like 'Sign in with Google') that handles secure logins and user verification."
      },
      {
        name: "Supabase",
        analogy: "An All-in-One Backend.",
        description: "A platform that gives developers a Database and Auth in one place, allowing them to skip weeks of backend setup."
      },
      {
        name: "API",
        analogy: "The Waiter at a restaurant.",
        description: "The messenger that takes a request from your app, gets data from another app (like Google Maps), and brings it back to you."
      },
      {
        name: "REST API",
        analogy: "The standardized Restaurant Menu.",
        description: "A universally agreed-upon style for APIs. It uses standard actions like GET (read) or POST (save) so communication is predictable."
      },
      {
        name: "MCP (Model Context Protocol)",
        analogy: "A Universal Translator for AI.",
        description: "A new standard bridge that lets AI models safely read your files or data without needing custom code for every single app."
      }
    ]
  },
  {
    ...
    terms: [
      {
        name: "Localhost",
        analogy: "Figma 'Present' Mode.",
        description: "A private server running only on your laptop. It's a testing ground that no one else on the internet can see."
      },
      {
        name: "Deployment",
        analogy: "Clicking 'Publish'.",
        description: "The process of moving the code from your private laptop (localhost) to a public server so real users can visit the URL."
      },
      {
        name: "Host (e.g., Vercel)",
        analogy: "The 24/7 Exhibition Hall.",
        description: "The company that provides the servers to keep your app live and accessible on the internet around the clock."
      },
      {
        name: "Docker",
        analogy: "The Shipping Container.",
        description: "Packages code with all its settings so it works perfectly on any computer, preventing 'it works on my machine' bugs."
      }
    ]
  },
  {
    ...
    terms: [
      {
        name: ".md (Markdown)",
        analogy: "Keyboard-only formatting.",
        description: "A simple way to write rich text (bold, titles, lists) using symbols instead of buttons. It's the standard for dev notes."
      },
      {
        name: "README.md",
        analogy: "The 'Start Here' Cover Page.",
        description: "The absolute front door of a code project. It explains what the app is, how to install it, and how to use it."
      }
    ]
  },
  {
    ...
    terms: [
      {
        name: "Framework vs. npm",
        analogy: "The Blueprint vs. The Furniture.",
        description: "You build the house using a Framework (Next.js). You furnish it with pre-built pieces from npm (Package Manager)."
      },
      {
        name: "Node.js vs. Next.js",
        analogy: "The Electricity vs. The Appliance.",
        description: "Node.js is the underlying electricity. Next.js is the smart home system plugged into it."
      },
      {
        name: "App Router vs. API",
        analogy: "Internal Navigation vs. External Waiter.",
        description: "The App Router connects your own pages. An API connects your app to other companies' data."
      }
    ]
  }
];
...
export default function App() {
  ...
  const [viewMode, setViewMode] = useState('dictionary'); // 'dictionary' or 'flashcards'
  ...
  // Flattened cards for Flashcard Mode
  const flashcards = useMemo(() => {
    const cards: Array<{ name: string; analogy: string; description: string; categoryTitle: string }> = [];
  ...
  const handleAddTerm = (e: React.SyntheticEvent<HTMLFormElement>) => {
    e.preventDefault();
  ...
  return (
    <div className="flex h-screen bg-neutral-50 font-sans text-neutral-900 overflow-hidden">
      ...
      {/* Sidebar (Desktop) */}
      <aside className="w-72 bg-white border-r border-neutral-200 flex-shrink-0 flex-col hidden lg:flex z-20">
      ...
      <main className="flex-1 flex flex-col overflow-hidden relative">
        ...
        {/* Dynamic Content: Dictionary OR Flashcards */}
            ...
            <div className="p-6 lg:p-10 max-w-3xl mx-auto space-y-12 pb-32">
              {filteredData.length === 0 ? (
                <div className="text-center py-20 bg-white border-2 border-dashed border-neutral-200 rounded-3xl">
                  ...
                  <p className="text-neutral-500 mt-1">Try a different search query or browse the categories.</p>
                </div>
              ) : (
                ...
                <div className="w-full max-w-md flex flex-col items-center gap-8">
                  ...
                  >
                    ...
                    >
                      {/* Front of Card */}
                      <div
                        className="absolute inset-0 bg-white border border-neutral-200 rounded-3xl p-8 flex flex-col items-center justify-center text-center gap-4"
                      ...
                      {/* Back of Card */}
                      <div
                        className="absolute inset-0 bg-indigo-600 text-white rounded-3xl p-8 flex flex-col items-center justify-center text-center"
      ...
      {/* Add Term Modal */}
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-neutral-900/40 backdrop-blur-sm" onClick={() => setIsModalOpen(false)}>
          <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl p-6" onClick={e => e.stopPropagation()}>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-bold">Add New Jargon</h2>
              <button onClick={() => setIsModalOpen(false)} className="p-2 hover:bg-neutral-100 rounded-full"><X className="w-5 h-5"/></button>
            </div>
            <form onSubmit={handleAddTerm} className="space-y-4">
              <select className="w-full bg-neutral-50 border border-neutral-200 p-3 rounded-xl outline-none focus:ring-2 focus:ring-indigo-500/20" value={newTerm.category} onChange={e => setNewTerm({...newTerm, category: e.target.value})}>
                {glossary.map(c => <option key={c.id} value={c.id}>{c.title}</option>)}
              </select>
              <input className="w-full bg-neutral-50 border border-neutral-200 p-3 rounded-xl outline-none focus:ring-2 focus:ring-indigo-500/20" placeholder="Term Name (e.g. Serverless)" value={newTerm.name} onChange={e => setNewTerm({...newTerm, name: e.target.value})} />
              <input className="w-full bg-neutral-50 border border-neutral-200 p-3 rounded-xl outline-none focus:ring-2 focus:ring-indigo-500/20" placeholder="Think of it like..." value={newTerm.analogy} onChange={e => setNewTerm({...newTerm, analogy: e.target.value})} />
              <textarea className="w-full bg-neutral-50 border border-neutral-200 p-3 rounded-xl outline-none focus:ring-2 focus:ring-indigo-500/20 h-24 resize-none" placeholder="Explain it simply..." value={newTerm.description} onChange={e => setNewTerm({...newTerm, description: e.target.value})} />
              <button className="w-full py-3.5 bg-indigo-600 text-white rounded-xl font-bold shadow-lg shadow-indigo-100 hover:bg-indigo-700 transition-colors">Save Term</button>
            </form>
          </div>
        </div>
      )}
